...
type MyMessage struct {
	Unsigned   *jsoniter.RawMessage `json:"unsigned"`
	Content    *jsoniter.RawMessage `json:"content"`
	Signatures *jsoniter.RawMessage `json:"signatures,omitempty"`
}
...
func TestSignJSONWithUnsigned(t *testing.T) {
	...
	entityName := "example.com"
	keyID := KeyID("ed25519:my_key_id")
	content := jsoniter.RawMessage(`{"signed":"data"}`)
	unsigned := jsoniter.RawMessage(`{"unsigned":"data"}`)
	...
	newUnsigned := jsoniter.RawMessage(`{"different":"data"}`)
