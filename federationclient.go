...
// WithUnstable returns a wrapped version of this FederationClient that allows
// access to unstable non-specced functions.
func (ac *FederationClient) WithUnstable() *UnstableFederationClient {
	return &UnstableFederationClient{ac}
}
